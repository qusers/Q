...
extern float *D_lambdas;
extern int *D_LJ_matrix;
extern bool *D_excluded;

// Q-W interactions
__device__ void calc_qw_dvel_matrix_incr(int row, int qi, int column, int n_lambdas, float crg_ow, float crg_hw, float A_O, float B_O,
    coord_t *Qs, coord_t *Ws, float *Evdw, float *Ecoul, calc_qw_t *qw,
    q_catype_t *D_qcatypes, q_atype_t *D_qatypes, q_charge_t *D_qcharges, q_atom_t *D_qatoms, float *D_lambdas, topo_t topo);
...
__device__ void calc_qp_dvel_matrix_incr(int row, int qi, int column, int pj, int n_lambdas, int n_qatoms,
    coord_t *Qs, coord_t *Ps, int *LJs, bool *excluded_s, float *Evdw, float *Ecoul, calc_qp_t *qp,
