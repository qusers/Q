...
For the reasons why such parameters are differently configured in the `prm` files Q, please refer to the [user's manual](http://qdyn.no-ip.org/documents/qman.pdf). Specifically, the following section:
