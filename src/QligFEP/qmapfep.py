...
from Qgpu import ccc, metrics, plot
    ...
    def _adapt_input_json(self, json_file):
        ...
        for node_id, node_data in data["nodes"].items():
            adapted_node = {
                ...
                "payload": {
                    "dG": "Test",
                    "dGexpt": node_data.get("ddg_value", None)
                }
            }
        ...
        for edge_idx, edge_data in enumerate(data["edges"]):
            ...
            adapted_edge = {
                ...
                "payload": {
                    "ddG": "Test",
                    "ddGexpt": edge_data.get("ddg_value", None)
                }
            }
...
class Init:
    def __init__(self,
        ...
        if input_json is not None:
            ...
            raise AttributeError("No input file provided. Please provide either a .sdf or an existing .json file together with a .sdf file.")
