This test includes a single point energy calculation for a C24 chain in a water sphere of size 20A. 
...
python ../../bin/qdyn.py -t Q5_data/ala_wat.top -m Q5_data/eq1.inp -d TEST -r Q5_data/
