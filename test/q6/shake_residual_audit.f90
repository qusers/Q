! Diagnostic only: call Q's constraint solver on one water.
program shake_residual_audit
  use md
  implicit none
  real(8) :: reference(9), trial(9), residual, oh, hh, a, b, worst
  integer :: iterations, ic, left, right, sample, worst_sample, worst_bond
  ...
  write(*,'(a,2i8,2es26.17e3)') 'SHAKE_MAX ',worst_sample,worst_bond,worst,shake_tol
