...
workdir=/pfs/nobackup/home/w/wije/software/qgpu-qcalc/test/improper_test/FEP_PHE-ALA
inputfiles=/pfs/nobackup/home/w/wije/software/qgpu-qcalc/test/improper_test/FEP_PHE-ALA/inputfiles
length=${#fepfiles[@]}
length=$((length-1))
