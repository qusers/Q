...
2. Prepare the protein to run under spherical boundary conditions - input willem
...
**TODO: Analyze FEP part**

**Willem, could you update the text below and integrate it with the previous text?**
