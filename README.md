...
micromamba install openff-toolkit=0.16.4 "openff-utilities>=0.1.12" openff-forcefields=2024.09.0 openmm=8.1.1 "openff-nagl>=0.3.8" lomap2 kartograf -c conda-forge --yes
```
...
```bash
micromamba create -f environment.yml -n qligfep_new -y && micromamba activate qligfep_new && micromamba install openff-toolkit=0.16.4 "openff-utilities>=0.1.12" openff-forcefields=2024.09.0 openmm=8.1.1 "openff-nagl>=0.3.8" lomap2 kartograf -c conda-forge --yes && python -m pip install -e .
```
</details>
...
``` bash
micromamba create -n qligfep_new openff-toolkit=0.16.4 "openff-utilities>=0.1.12" openff-forcefields=2024.09.0 openmm=8.1.1 lomap2 kartograf -c conda-forge --yes
micromamba activate qligfep_new
